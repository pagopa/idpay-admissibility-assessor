...
class AnprDataRetrieverServiceImplTest {
    ...
    void setup() {
        ...
        residenceDataRetrieverService = new ResidenceDataRetrieverServiceImpl(anprC001RestClientMock, criteriaCodeServiceMock, residenceMapper);
    ...
    void testInvokeOK() {
        // Given
        Mockito.when(anprC001RestClientMock.invoke(ACCESS_TOKEN, FISCAL_CODE,agidJwtTokenPayload)).thenReturn(Mono.just(anprAnswer));
    ...
    void testInvokeDailyLimitException() {
        // Given
        Mockito.when(anprC001RestClientMock.invoke(ACCESS_TOKEN, FISCAL_CODE,agidJwtTokenPayload)).thenReturn(Mono.error(AnprDailyRequestLimitException::new));
