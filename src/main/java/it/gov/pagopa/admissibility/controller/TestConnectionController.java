...
public interface TestConnectionController {
    ...
    Mono<ConsultazioneSogliaIndicatoreResponse> getThreshold(@PathVariable("threshold") String threshold, @RequestHeader("X-User-Code") String userCode, @RequestHeader("X-Data") String date);
}
